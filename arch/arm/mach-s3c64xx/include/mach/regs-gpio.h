...
#define S3C64XX_GPIOREG(reg)	(S3C64XX_VA_GPIO + (reg))//ÎïÀíµØÖ·ÊÇ0x7F008000£¬S3C64XX_VA_GPIOÊÇÐéÄâµØÖ·
//GPA~Q¸÷¸öGPIO¿ÚµÄ»ùµØÖ·
#define S3C64XX_GPA_BASE	S3C64XX_GPIOREG(0x0000)//0x7F008000¼û6410ÊÖ²á10.4.1 MEMORY MAP  p380
#define S3C64XX_GPB_BASE	S3C64XX_GPIOREG(0x0020)//0x7F008020
#define S3C64XX_GPC_BASE	S3C64XX_GPIOREG(0x0040)//0x7F008040
...
#define S3C64XX_GPQ_BASE	S3C64XX_GPIOREG(0x0180)//0x7F008180

/* Ã===============================SPCON========================================= */

#define S3C64XX_SPCON		S3C64XX_GPIOREG(0x1A0)//SPCON¼Ä´æÆ÷µØÖ·£º0x7F0081A0
//SPCON¼Ä´æÆ÷Ïà¹ØÎ»ÉèÖ
...
/* Ã================External interrupt registers Íâ²¿ÖÐ¶Ï¼Ä´æÆ÷================*/

#define S3C64XX_EINT12CON	S3C64XX_GPIOREG(0x200)//0x7F008200
...
#define S3C64XX_SPCONSLP	S3C64XX_GPIOREG(0x880)//SPCONSLP¼Ä´æÆ÷µØÖ·£º0x7F008880
