 ...
 *
 * S3C64XX - GPIO memory port register definitions  GPIOÄÚ´æ¶Ë¿Ú¼Ä´æÆ÷MEM0CONSTOP
 */

#ifndef __ASM_PLAT_S3C64XX_REGS_GPIO_MEMPORT_H
#define __ASM_PLAT_S3C64XX_REGS_GPIO_MEMPORT_H __FILE__

#define S3C64XX_MEM0CONSTOP	S3C64XX_GPIOREG(0x1B0)//MEM0CONSTOP¼Ä´æÆ÷µØÖ· 0x7F0081B0
