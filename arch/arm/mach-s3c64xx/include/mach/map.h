 ...
 *
 * S3C64XX - Memory map definitions==========其中VA表示虚拟地址，PA表示物理地址
 *==========各外设（包括GPIO）的寄存器地址映射===========================
...
#define S3C64XX_PA_XM0CSN0 (0x10000000)//其中VA表示虚拟地址，PA表示物理地址
...
//其中VA表示虚拟地址，PA表示物理地址
//==================见6410手册 p117  各外设（包括GPIO）的地址映射图================
#define S3C64XX_PA_SROM		(0x70000000)//p208  SROM_BW寄存器地址
#define S3C64XX_PA_NAND		(0x70200000)//p258   NAND Flash Configuration register  NFCONF寄存器地址
#define S3C64XX_PA_FB		(0x77100000)
#define S3C64XX_PA_USB_HSOTG	(0x7C000000)
#define S3C64XX_PA_WATCHDOG	(0x7E004000)//其中VA表示虚拟地址，PA表示物理地址
...
#define S3C64XX_PA_IIC0		(0x7F004000)//控制寄存器IIC Channel 0 Bus control register
...
#define S3C64XX_PA_IIC1		(0x7F00F000)//控制寄存器IIC Channel 0 Bus control register

#define S3C64XX_PA_GPIO		(0x7F008000)//GPIO寄存器起始物理地址
#define S3C64XX_VA_GPIO		S3C_ADDR_CPU(0x00000000)//是虚拟地址，物理地址是0x7F008000//其中VA表示虚拟地址，PA表示物理地址
...
#define S3C64XX_VA_MODEM	S3C_ADDR_CPU(0x00100000)//其中VA表示虚拟地址，PA表示物理地址
...
#define S3C_PA_TIMER		S3C64XX_PA_TIMER//其中VA表示虚拟地址，PA表示物理地址
