...
#define S3C64XX_GPIO_NEXT(__gpio) \
	((__gpio##_START) + (__gpio##_NR) + CONFIG_S3C_GPIO_SPACE + 1)//__gpio替换掉，去掉##
...
/* S3C64XX GPIO 号定义number definitions. 单个GPIO脚的号码
