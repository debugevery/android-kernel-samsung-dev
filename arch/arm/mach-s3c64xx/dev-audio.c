...
struct platform_device s3c64xx_device_iis0 = {//iis0平台设备================
	.name		  = "s3c64xx-iis",
	.id		  = 0,
...
struct platform_device s3c64xx_device_iis1 = {//iis1平台设备================
	.name		  = "s3c64xx-iis",
	.id		  = 1,
...
struct platform_device s3c64xx_device_iisv4 = {//iis4平台设备================
	.name		  = "s3c64xx-iis-v4",
	.id		  = -1,
...
/* PCM Controller platform_devices   PCM音频平台设备======================================== */
...
struct platform_device s3c64xx_device_pcm0 = {//pcm0平台设备================
	.name		  = "samsung-pcm",
	.id		  = 0,
...
struct platform_device s3c64xx_device_pcm1 = {//pcm1平台设备================
	.name		  = "samsung-pcm",
	.id		  = 1,
...
/* AC97 Controller platform devices   AC97音频平台设备========================================*/
...
struct platform_device s3c64xx_device_ac97 = {//ac97平台设备================
	.name		  = "s3c-ac97",
	.id		  = -1,
