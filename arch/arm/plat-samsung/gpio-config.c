 ...
 *
 * S3C series GPIO configuration core  GPIO设置基本核心函数
 *
...
int s3c_gpio_cfgpin(unsigned int pin, unsigned int config)//设置端口配置寄存器Configuration Register
{
