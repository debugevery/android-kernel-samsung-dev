...
#define S3C2410_UFCON_FIFOMODE	  (1<<0)//S3C2410 UART UFCONn寄存器的位掩码和默认设置
...
*/
//UART的设置（UCONn、ULCONn、UFCONn寄存器等）被封装到s3c2410_uartcfg结构体中
struct uart_port;
...
struct s3c2410_uartcfg {
	...
	unsigned long	   ucon;	 /* value of ucon for portUART控制寄存器的值，即 UCON0、UCON1、 UCON2 和 ULCON3 */
	unsigned long	   ulcon;	 /* value of ulcon for port行控制寄存器的值，即 ULCON0、ULCON1、ULCON2 和 ULCON3 */
	unsigned long	   ufcon;	 /* value of ufcon for portFIFO 控制寄存器的值 */
