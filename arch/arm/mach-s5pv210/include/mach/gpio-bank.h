...
//¸÷GPIO¼Ä´æÆ÷µØÖ·
#define S5PV210_GPA0CON			(S5PV210_GPA0_BASE + 0x00)//(S5P_VA_GPIO+0x000)+0x00=S3C_ADDR(0x00500000)+0x000+0x00 = (S3C_ADDR_BASE+x)+0x000)+0x00=((0xFD000000)+(x)+0x000)+0x00= 0xFD500000
