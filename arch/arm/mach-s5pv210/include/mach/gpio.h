...
/* GPIO bank sizes *//* GPIO bank sizes每组GPIO的数目 */
#define S5PV210_GPIO_A0_NR	(8)// =8
...
enum s5p_gpio_number {
	...
	S5PV210_GPIO_A1_START	= S5PV210_GPIO_NEXT(S5PV210_GPIO_A0),//=S5PV210_GPIO_A0_START + S5PV210_GPIO_A0_NR + CONFIG_S3C_GPIO_SPACE + 1
...
0+32+5=37, 
*/
#define S5PV210_GPA0(_nr)	(S5PV210_GPIO_A0_START + (_nr))//=S5PV210_GPIO_A0_START + _nr 
