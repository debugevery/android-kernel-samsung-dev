 ...
 *
 * S5PV210 - IRQ definitions============中断相关标志位宏===================
 *
...
/* VIC0 矢量中断控制器VIC0：支持64个中断中的32个*/
#define IRQ_EINT0		S5P_IRQ_VIC0(0)//(S5P_VIC0_BASE + (x))//=S5P_IRQ(0)+ (x)=(0 + S5P_IRQ_OFFSET)+ (x)=(0 + (32)+ (x)=32+ (x)=32
#define IRQ_EINT1		S5P_IRQ_VIC0(1)//=33
#define IRQ_EINT2		S5P_IRQ_VIC0(2)//=34
...
#define IRQ_FIMC3		S5P_IRQ_VIC0(31)//63

/* VIC1: ARM, Power, Memory, Connectivity, Storage */
/* VIC1 矢量中断控制器VIC1：支持64个中断中的32个*/
#define IRQ_PMU			S5P_IRQ_VIC1(0)//=64
...
#define IRQ_ONENAND_AUDI	S5P_IRQ_VIC1(31)//=95

/* VIC2: Multimedia, Audio, Security */

#define IRQ_LCD0		S5P_IRQ_VIC2(0)//=96
