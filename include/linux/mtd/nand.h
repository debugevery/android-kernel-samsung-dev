...
/*
 * Standard NAND flash commands=============标准nand flash命令
 */
...
/* Extended commands for large page devices =========扩展命令*/
...
struct nand_chip {
	void  __iomem	*IO_ADDR_R; //读8根I/O线的地址
	void  __iomem	*IO_ADDR_W; //写8根I/O线的地址
	...
	void		(*select_chip)(struct mtd_info *mtd, int chip);//控制CE信号 
	...
	void		(*cmd_ctrl)(struct mtd_info *mtd, int dat,
				    unsigned int ctrl);
	int		(*dev_ready)(struct mtd_info *mtd); //板特定的设备ready/busy信息
