...
check_tx_pwr_validity_11d(t_u8 tx_pwr)
{
    ...
    t_u16 buf_len = 0;
    int ret = UAP_FAILURE;
    int i, j, found = 0, band = BAND_B | BAND_G;
...
{
    printf
        ("\nUsage : sys_cfg_wmm  [qos_info=<qos_info>] [AC_BE AIFSN ECW_MAX ECW_MIN TX_OP]\n");
