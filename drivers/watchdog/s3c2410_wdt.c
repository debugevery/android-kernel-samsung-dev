...
static const struct file_operations s3c2410wdt_fops = {//混杂设备操作函数
	.owner		= THIS_MODULE,
	.llseek		= no_llseek,
...
static struct miscdevice s3c2410wdt_miscdev = {//混杂设备结构体
	.minor		= WATCHDOG_MINOR,
	.name		= "watchdog",
	.fops		= &s3c2410wdt_fops,//混杂设备操作函数
};
...
static int __devinit s3c2410wdt_probe(struct platform_device *pdev)
{
	...
	ret = misc_register(&s3c2410wdt_miscdev);//============注册混杂设备，包含混杂设备看门狗的相关操作函数
	if (ret) {
