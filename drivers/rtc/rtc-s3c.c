...
static const struct rtc_class_ops s3c_rtcops = {//RTC相关操作函数
	.open		= s3c_rtc_open,
...
static int __devinit s3c_rtc_probe(struct platform_device *pdev)
{
	...
	rtc = rtc_device_register("s3c", &pdev->dev, &s3c_rtcops,//注册RTC========RTC相关操作函数
				  THIS_MODULE);
