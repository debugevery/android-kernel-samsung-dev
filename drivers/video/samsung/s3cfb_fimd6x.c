...
{//见210 datasheet p1231:  Display On: ENVID and ENVID_F are set to “1”. 
	u32 cfg;
...
{//见210 datasheet p1231: Direct Off: ENVID and ENVID_F are set to “0” simultaneously. 
	u32 cfg;
...
{//见210 datasheet p1231: Per Frame Off: ENVID_F is set to “0” and ENVID is set to “1”. 
	u32 cfg;
...
*/
	...
	vclk = PICOS2KHZ(ctrl->fb[pdata->default_win]->var.pixclock) * 1000000;
...
{//一帧结束时产生中断。//见210 datasheet p1262
	u32 cfg = 0;
