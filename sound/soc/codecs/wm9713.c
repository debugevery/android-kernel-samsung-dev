/*
 * wm9713.c  --  ALSA Soc WM9713 codec support   // WM9713/WM9714 ASOC Codec 驱动
 *支持WM9713、WM9714，主要定义了一系列的mixer 控制、DAPM、AC97 底层读写、时钟/PLL 控制以及snd_soc_ops 的成员函数。
...
static const struct soc_enum wm9713_enum[] = {/* 一系列的mixer 控制 */
...
static const struct snd_soc_dapm_widget wm9713_dapm_widgets[] = {/* 一系列的dapm 控制 */
...
static unsigned int ac97_read(struct snd_soc_codec *codec,/* io、时钟、格式等的操作 */
	unsigned int reg)
{
