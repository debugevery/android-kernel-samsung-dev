 ...
 *
 * ALSA SoC Audio Layer - S3C AC97 Controller driver  平台驱动:实现S3C6410 CPU 端的DAI 驱动
...
struct snd_soc_dai s3c_ac97_dai[] = {//CODEC DAI（Digital Audio Interfaces）和配置PCM,形容playback、capture的属性以及DAI接口的操作
	[S3C_AC97_DAI_PCM] = {
		.name =	"s3c-ac97",
		.id = S3C_AC97_DAI_PCM,
		.ac97_control = 1,
